...
PYTHON = [
    "verifica_ids", "prueba_dependencias", "prueba_construir_lf", "prueba_llave_google_variable", "prueba_respaldo", "prueba_columnas_declaradas", "prueba_migra_identidades_sola", "prueba_fotos_separadas", "prueba_calculo", "prueba_archivos", "prueba_permisos", "prueba_pdf_permiso", "prueba_firma_pdf", "prueba_reportes",
